...
<body>
    ...
    <form action="simpan.php" method="POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="inputText3" placeholder="Nama Lengkap" name="nama_pemesan">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" id="inputNumber3" placeholder="Nomor Identitas" name="nomor_identitas">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" id="inputNumber3" placeholder="Nomer HP" name="no_hp">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select name="tempat_wisata" class="form-control" id="wisata">
                    <option value="Danau Cibereum">Danau Cibereum</option>
                    <option value="Curug Parigi">Curug Parigi</option>
                    <option value="Taman Rusa Kemang">Taman Rusa Kemang</option>
                </select>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" id="inputNumber3" placeholder="Jumlah Orang" name="pengunjung_dewasa">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" id="inputNumber3" placeholder="Jumlah Orang" name="pengunjung_anak">
        ...
        <p>Total Bayar &ensp; &ensp; &ensp; &ensp; &ensp; &ensp; &ensp; &ensp; &ensp; &ensp; &ensp; &ensp; &ensp; &ensp; <b>Rp. 0</b></p>
        ...
        <br>
        <input type="submit" id="" name="Total Bayar" value="Hitung Total Bayar" class="btn btn-dark " style="margin-left: 170px;">
        <input type="submit" id="" name="Pesan Tiket" value="Pesan Tiket" class="btn btn-dark ">
        <input type="reset" id="" name="Cancels" value="Cancel" class="btn btn-dark ">
    </form>
</body>
